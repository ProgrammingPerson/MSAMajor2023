...
def majors():
    ...
    for student in student_data:
        if student['major'] not in different_majors:
            different_majors.append(student['major'])
    ...
    if request.method == 'POST':
        ...
        if not major:
            ...
            for student in student_data:
                ...
                return render_template('majors.html', different_majors=different_majors, result_list=result_list)

    return render_template('majors.html', different_majors=different_majors)
